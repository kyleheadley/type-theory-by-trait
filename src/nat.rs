...
impl<N:Type<Nat>> Judge2<Nat,Nat,Succ<N>,Zero> for GreaterThan {}
impl<N1:Type<Nat>,N2:Type<Nat>> Judge2<Nat,Nat,Succ<N1>,Succ<N2>> for GreaterThan where
  GreaterThan: Judge2<Nat,Nat,N1,N2>
{}
