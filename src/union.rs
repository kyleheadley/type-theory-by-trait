...
impl<T1:Typed,T2:Typed,A:Typed<T=T1>> Typed for Inl<T1,T2,A> {type T=Coproduct<T1,T2>;}
/// Constructor for unions of right type
pub struct Inr<T1,T2,B>(T1,T2,B);
impl<T1:Typed,T2:Typed,B:Typed<T=T2>> Typed for Inr<T1,T2,B> {type T=Coproduct<T1,T2>;}
